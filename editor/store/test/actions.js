...
describe( 'actions', () => {
	...
	describe( 'updateBlockListSettings', () => {
		it( 'should return the UPDATED_BLOCK_LIST_SETTINGS with undefined settings', () => {
		...
		it( 'should return the UPDATED_BLOCK_LIST_SETTINGS action with the passed settings', () => {
